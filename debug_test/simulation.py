...
if main_visualize:
    ...
    for sampler_init in sampler_initilizations:
        ...
        result = min_values[sampler_initilizations.index(sampler_init), :, :].T
        ...
        plt.tight_layout()
        plt.show()
        plt.savefig(f"../results/figs/simulation_Starfish/min_gwds_{sampler_init}.png")
        ...
        plt.tight_layout()
        plt.show()
        plt.savefig(f"../results/figs/simulation_Starfish/min_indices_{sampler_init}.png")
    ...
    for noise_deg in noise_deg_list:
        ...
        plt.xlabel("Symmetry Degree")
        plt.ylabel("Min GWD")
        plt.title(f"Min GWDs for {sampler_init} with noise degree {noise_deg:.2f}")
        plt.tight_layout()
        plt.legend()
        plt.show()
        plt.savefig(f"../results/figs/simulation_Starfish/min_gwds_noise{noise_deg}.png")
# %%
