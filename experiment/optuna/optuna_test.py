...
study = optuna.create_study(study_name="my_study", storage = "sqlite:///test.db", load_if_exists = True)


def multi_run(dataset, seed):
    sampler = optuna.samplers.RandomSampler(seed = seed)
    loaded_study = optuna.load_study(sampler = sampler, study_name="my_study", storage="sqlite:///test.db")
