"""
This module contains functions showing similarity matrices.

For details on the keyword arguments, please refer to the `show_heatmap`.

Functions:
    - show_sim_mat: Function to display similarity matrices for AlignRepresentations.
    - show_sim_mat_rep: Function to display similarity matrices for a single Representation.
    - show_heatmap: Function to display a heatmap of the given matrix with various customization options.
"""
